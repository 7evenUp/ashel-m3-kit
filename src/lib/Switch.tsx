      ...
      <div
        className={cn(
          `absolute rounded-full transition-all flex items-center justify-center
           peer-checked:h-6 peer-checked:w-6
           group-active:h-[28px] group-active:w-[28px]
           group-active:translate-y-[2px] group-active:translate-x-[2px]
           group-active:peer-checked:h-[28px] group-active:peer-checked:w-[28px]
           group-active:peer-checked:translate-y-[2px] group-active:peer-checked:translate-x-[22px]
           peer-checked:translate-y-1 peer-checked:translate-x-6
           bg-light-outline dark:bg-dark-outline
           peer-checked:bg-light-onPrimary dark:peer-checked:bg-dark-onPrimary
           group-hover:bg-light-onSurfaceVariant dark:group-hover:bg-dark-onSurfaceVariant
           group-hover:peer-checked:bg-light-primaryContainer dark:group-hover:peer-checked:bg-dark-primaryContainer`,
          unselectedIcon
